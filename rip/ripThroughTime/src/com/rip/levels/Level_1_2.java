...
public class Level_1_2 extends Level {
	...
	public void generateBackground() {
		ground1 = new Pixmap(Gdx.files.internal("level1_2/ground1.png"));
		ground2 = new Pixmap(Gdx.files.internal("level1_2/ground2.png"));
		ground3 = new Pixmap(Gdx.files.internal("level1_2/ground3.png"));
		ground4 = new Pixmap(Gdx.files.internal("level1_2/ground4.png"));
		...
		s = new Pixmap(Gdx.files.internal("level1_2/sky.png"));
		sk = new BackgroundObject(s,0,0);
		
		
		//random tree objects.
		tree1 = new Pixmap(Gdx.files.internal("level1_2/tree1.png"));
		tree2 = new Pixmap(Gdx.files.internal("level1_2/tree2.png"));
		tree3 = new Pixmap(Gdx.files.internal("level1_2/tree3.png"));
		tree4 = new Pixmap(Gdx.files.internal("level1_2/tree4.png"));
		tree5 = new Pixmap(Gdx.files.internal("level1_2/tree5.png"));
		tree6 = new Pixmap(Gdx.files.internal("level1_2/tree6.png"));
		tree7 = new Pixmap(Gdx.files.internal("level1_2/tree7.png"));
		tree8 = new Pixmap(Gdx.files.internal("level1_2/tree8.png"));
		tree9 = new Pixmap(Gdx.files.internal("level1_2/tree9.png"));
		tree10 = new Pixmap(Gdx.files.internal("level1_2/tree10.png"));
		...
		//random bush objects.
		bush1 = new Pixmap(Gdx.files.internal("level1_2/flower1.png"));
		bush2 = new Pixmap(Gdx.files.internal("level1_2/flower2.png"));
		bush3 = new Pixmap(Gdx.files.internal("level1_2/flower3.png"));
		bush4 = new Pixmap(Gdx.files.internal("level1_2/flower4.png"));
		...
		volcano1 = new Pixmap(Gdx.files.internal("level1_2/volcano.png"));
		volcano2 = new Pixmap(Gdx.files.internal("level1_2/volcanosmall.png"));
		...
		cloud1 = new Pixmap(Gdx.files.internal("level1_2/cloud1.png"));
		cloud2 = new Pixmap(Gdx.files.internal("level1_2/cloud2.png"));
		cloud3 = new Pixmap(Gdx.files.internal("level1_2/cloud3.png"));
		cloud4 = new Pixmap(Gdx.files.internal("level1_2/cloud4.png"));
		...
		debris1 = new Pixmap(Gdx.files.internal("level1_2/smallgrass.png"));
		debris2 = new Pixmap(Gdx.files.internal("level1_2/smallrock1.png"));
		debris3 = new Pixmap(Gdx.files.internal("level1_2/smallrock2.png"));
		...
		//fog objects
		fog1 = new Pixmap(Gdx.files.internal("level1_2/fog1.png"));
		fog2 = new Pixmap(Gdx.files.internal("level1_2/fog2.png"));
		fog3 = new Pixmap(Gdx.files.internal("level1_2/fog3.png"));
		fog4 = new Pixmap(Gdx.files.internal("level1_2/fog4.png"));
